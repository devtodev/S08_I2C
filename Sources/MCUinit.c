...
**     Date/Time : 17/10/2013, 08:08 p.m.
**     Abstract  :
...
void MCU_init(void)
{
  ...
  /* ### Init_GPIO init code */
  /* PTBD: PTBD4=0,PTBD3=1,PTBD2=1,PTBD1=0,PTBD0=0 */
  PTBD = (PTBD & (unsigned char)~19) | (unsigned char)12;
  /* PTBPE: PTBPE7=1,PTBPE6=1,PTBPE5=1 */
  PTBPE |= (unsigned char)224;                      
  /* PTBDD: PTBDD7=0,PTBDD6=0,PTBDD5=0,PTBDD4=1,PTBDD3=1,PTBDD2=1,PTBDD1=1,PTBDD0=1 */
  PTBDD = 31;                                      
  /* ### */
} /*MCU_init*/
